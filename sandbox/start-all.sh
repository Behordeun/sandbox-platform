...
echo "AI Service:      http://127.0.0.1:8002/health"
echo "SMS Service:     http://127.0.0.1:8003/health"
echo "IVR Service:     http://127.0.0.1:8004/health"
echo "NIN Service:     http://127.0.0.1:8005/health"
echo "BVN Service:     http://127.0.0.1:8006/health"
echo "Two-Way SMS:     http://127.0.0.1:8007/health"
