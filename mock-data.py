...
NIGERIAN_FIRST_NAMES = [
    "Adebayo", "Chioma", "Emeka", "Fatima", "Ibrahim", "Kemi", "Olumide", 
    "Aisha", "Chinedu", "Folake", "Musa", "Ngozi", "Tunde", "Zainab"
]

NIGERIAN_LAST_NAMES = [
    "Ogundimu", "Okoro", "Adebayo", "Mohammed", "Okafor", "Adeleke", 
    "Bello", "Chukwu", "Danjuma", "Eze", "Garba", "Hassan", "Igwe"
]
