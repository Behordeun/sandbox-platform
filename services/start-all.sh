...
echo "Auth Service:      http://127.0.0.1:8000/health"
echo "API Gateway:       http://127.0.0.1:8080/health"
echo "Rate Limiter:      http://127.0.0.1:8008/health"
echo "Health Service:    http://127.0.0.1:8009/health"
echo "Logging Service:   http://127.0.0.1:8010/health"
echo "Monitoring:        http://127.0.0.1:8011/health"