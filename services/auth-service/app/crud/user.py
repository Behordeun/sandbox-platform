...
class CRUDUser(CRUDBase[User, UserCreate, UserUpdate]):
    ...
    def verify_nin(self, db: Session, *, user: User, nin: str, verification_data: dict = None) -> User:
    ...
    def verify_bvn(self, db: Session, *, user: User, bvn: str, verification_data: dict = None) -> User:
